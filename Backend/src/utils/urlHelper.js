...
export const toFullUrl = (filePath) => {
    ...
    // It is a relative file path (e.g. "uploads/food/explore-icons/abc.webp" or "/uploads/food/explore-icons/abc.webp")
...
export const transformImageFields = (data) => {
    ...
    // Handle Mongoose documents that might have .toObject() or are not plain objects
    let target = data;
