      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-6">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-orange-400 to-[var(--primary-theme)] flex items-center justify-center">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                activeTab === "customer-login"
                  ? "bg-[var(--primary-theme)] text-white"
        ...
        {activeTab === "customer-login" && (
          <div className="space-y-6">
                  ...
                  <div
                    ...
                    className={`border-2 rounded-lg p-4 cursor-pointer transition-all ${
                      loginOptions[option.key]
                        ? "border-[var(--primary-theme)] bg-orange-50"
                    ...
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--primary-theme)] focus:ring-offset-2 ${
                            loginOptions[option.key] ? "bg-[var(--primary-theme)]" : "bg-slate-300"
                          }`}
                        >
                          <span
            ...
            <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
              <p className="text-sm text-slate-600 mb-4">
                <a href="#" className="text-[var(--primary-theme)] hover:text-[var(--primary-theme)] hover:underline">
                      ...
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--primary-theme)] focus:ring-offset-2 ${
                              socialMedia[platform.key] ? "bg-[var(--primary-theme)]" : "bg-slate-300"
                            }`}
                          >
                            <span
                              className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--primary-theme)] focus:ring-offset-2 ${
                            verification[verify.key] ? "bg-[var(--primary-theme)]" : "bg-slate-300"
                          }`}
                        >
                          <span
                            className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                            ...
                            {editingId === panel.id ? (
                              <div className="flex items-center gap-2">
                                <input
                                  ...
                                  className="flex-1 px-3 py-2 text-sm border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--primary-theme)] focus:border-[var(--primary-theme)]"
                                  placeholder="Enter login URL"
                                />
                                <button
                                  onClick={() => handleSaveUrl(panel.id)}
                                  className="px-3 py-2 text-sm bg-[var(--primary-theme)] text-white rounded-lg hover:bg-[var(--primary-theme)] transition-colors"
                                >
                                  Save
                                </button>
                                <button
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <a
                                  ...
                                  className="text-[var(--primary-theme)] hover:text-[var(--primary-theme)]"
        ...
        <div className="flex justify-end gap-3 mt-6">
          ...
          <button
            ...
            className="px-6 py-2.5 bg-[var(--primary-theme)] text-white rounded-lg hover:bg-[var(--primary-theme)] transition-colors font-medium"
          >
            Submit
          </button>
        </div>
            ...
            <div className="px-6 pb-6 space-y-4">
                  ...
                  {Object.entries(columnsConfig).map(([key, label]) => (
                    ...
                    >
                      <input
                        ...
                        className="w-4 h-4 text-[var(--primary-theme)] border-slate-300 rounded focus:ring-[var(--primary-theme)]"
                      />
                      <span className="text-sm text-slate-700">{label}</span>
                      {visibleColumns[key] && (
                        <Check className="w-4 h-4 text-[var(--primary-theme)] ml-auto" />
                      )}
                    </label>
                  ))}
                </div>
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-200">
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium rounded-lg bg-[var(--primary-theme)] text-white hover:bg-[var(--primary-theme)] transition-all shadow-md"
                >
                  Apply
                </button>
              </div>
