...
import { Lock, Eye, EyeOff, Save, Loader2, Shield, User, Mail, Truck, Code2, KeyRound } from "lucide-react";
...
export default function AdminSettings() {
  const [activeTab, setActiveTab] = useState("developer"); // Default tab or account
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-neutral-600 mt-1">
            Manage account security, sub-admins, and developer reviewer mode.
          </p>
        </div>

        {/* Tab Selector Buttons */}
        <div className="flex items-center gap-1.5 p-1.5 bg-neutral-100 border border-neutral-200 rounded-xl">
          <button
            type="button"
