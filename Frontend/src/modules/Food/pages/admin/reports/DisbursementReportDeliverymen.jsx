...
import { emptyDisbursementReportDeliverymen, emptyDisbursementStats } from "@food/utils/adminFallbackData"
  ...
  const filteredDisbursements = useMemo(() => {
    ...
    if (searchQuery.trim()) {
      ...
      result = result.filter(disbursement =>
        ...
        disbursement.deliveryManName.toLowerCase().includes(query)
      )
    }
    ...
    <div className="p-4 lg:p-6 bg-slate-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 relative">
            <div className="absolute top-4 right-4">
              <div className="w-5 h-5 rounded-full bg-[var(--primary-theme)] flex items-center justify-center">
                <Info className="w-3 h-3 text-white" />
              </div>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="w-16 h-16 rounded-full bg-[var(--primary-theme)] flex items-center justify-center mb-4">
