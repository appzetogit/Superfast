...
export default function AuthCallback() {
  ...
  return (
    <AnimatedPage 
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50/30 via-white to-orange-100/20 dark:from-gray-900 dark:via-[#0a0a0a] dark:to-gray-900 p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12"
      style={{ '--primary-theme': '#f97316' }}
    >
