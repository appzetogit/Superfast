    ...
    >
      <div className="h-full overflow-hidden rounded-2xl bg-white shadow-md ring-1 ring-[#efe2d3]">
        <div className={`relative h-48 overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(204,37,50,0.24),transparent_28%),linear-gradient(135deg,#fff5f5_0%,#fff5f5_100%)] sm:h-56 md:h-60 lg:h-64 xl:h-72 ${shimmerClassName}`}>
          ...
          <div className="absolute bottom-0 left-0 right-0 h-[40%] bg-gradient-to-r from-[var(--primary-theme)] to-transparent/20">
              ...
              <div className="w-full relative">
                <div className="relative bg-white dark:bg-[#1a1a1a] rounded-xl shadow-lg border border-gray-200 dark:border-gray-800 p-1 sm:p-1.5 transition-all duration-300 hover:shadow-xl">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <Search className="h-4 w-4 sm:h-4 sm:w-4 text-[var(--primary-theme)] flex-shrink-0 ml-2 sm:ml-3" strokeWidth={2.5} />
                ...
                <div className="absolute bottom-4 left-1/2 z-10 flex -translate-x-1/2 items-center gap-2 rounded-full bg-black/25 px-3 py-1.5 backdrop-blur-sm">
                  {diningHeroBanners.map((banner, index) => (
                    <button
                      ...
                      className={`h-2 rounded-full transition-all duration-300 ${currentBannerIndex === index ? "w-5 bg-white" : "w-2 bg-white/55"
                        }`}
                    />
                  ))}
                </div>
                      ...
                      >
                        <Card className="overflow-hidden gap-0 cursor-pointer border-0 dark:border-gray-800 group bg-white dark:bg-[#1a1a1a] shadow-md transition-all duration-500 py-0 rounded-2xl h-full flex flex-col w-full relative">
                          ...
                          <div className="relative h-48 sm:h-56 md:h-60 lg:h-64 xl:h-72 w-full overflow-hidden rounded-t-2xl flex-shrink-0">
                            ...
                            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-r from-[var(--primary-theme)] to-transparent" style={{ height: '40%' }}>
                            ...
                            <CardContent className="p-3 sm:p-4 pt-3 sm:pt-4">
                              ...
                              <div className="flex items-start justify-between gap-2 mb-2">
                                <div className="flex-1 min-w-0">
                                  <motion.h3
                                    ...
                                    variants={{
                                      rest: {},
                                      hover: { color: "var(--primary-theme, #cc2532)" }
                                    }}
                                    transition={{ duration: 0.3 }}
                                  >
                                    {restaurant.name}
                              ...
                              {restaurant.offer && (
                                <div className="flex items-center gap-2 text-sm">
                                  <span className="inline-flex h-5 min-w-5 items-center justify-center rounded-full bg-[#FFF5F5] px-1.5 text-[10px] font-bold uppercase tracking-[0.18em] text-[var(--primary-theme)]">
                                    Offer
                                  </span>
          ...
          <div className="absolute bottom-0 left-0 right-0 md:left-1/2 md:right-auto md:-translate-x-1/2 md:max-w-4xl bg-white dark:bg-[#1a1a1a] rounded-t-3xl md:rounded-3xl max-h-[85vh] md:max-h-[90vh] flex flex-col animate-[slideUp_0.3s_ease-out]">
            ...
            <div className="flex items-center justify-between px-4 md:px-6 py-4 md:py-5 border-b dark:border-gray-800">
              ...
              <button
                ...
                className="text-[var(--primary-theme)] font-medium text-sm md:text-base"
              >
                Clear all
              </button>
            </div>
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="flex flex-col gap-3 md:gap-4">
                      {[
                        ...
                        >
                          <span className={`text-sm md:text-base font-medium ${sortBy === option.id ? 'text-[var(--primary-theme)]' : 'text-gray-700 dark:text-gray-300'}`}>
                            {option.label}
                          </span>
                        </button>
                      ))}
                ...
                {activeFilterTab === 'time' && (
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      >
                        <Timer className={`h-6 w-6 ${activeFilters.has('delivery-under-30') ? 'text-[var(--primary-theme)]' : 'text-gray-600 dark:text-gray-400'}`} strokeWidth={1.5} />
                        <span className={`text-sm font-medium ${activeFilters.has('delivery-under-30') ? 'text-[var(--primary-theme)]' : 'text-gray-700 dark:text-gray-300'}`}>Under 30 mins</span>
                      </button>
                      <button
                      ...
                      >
                        <Timer className={`h-6 w-6 ${activeFilters.has('delivery-under-45') ? 'text-[var(--primary-theme)]' : 'text-gray-600 dark:text-gray-400'}`} strokeWidth={1.5} />
                        <span className={`text-sm font-medium ${activeFilters.has('delivery-under-45') ? 'text-[var(--primary-theme)]' : 'text-gray-700 dark:text-gray-300'}`}>Under 45 mins</span>
                      </button>
                    </div>
                  </div>
                )}
                ...
                {activeFilterTab === 'rating' && (
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      >
                        <Star className={`h-6 w-6 ${activeFilters.has('rating-35-plus') ? 'text-[var(--primary-theme)] fill-[var(--primary-theme)]' : 'text-gray-400 dark:text-gray-500'}`} />
                        <span className={`text-sm font-medium ${activeFilters.has('rating-35-plus') ? 'text-[var(--primary-theme)]' : 'text-gray-700 dark:text-gray-300'}`}>Rated 3.5+</span>
                      </button>
                      <button
                      ...
                      >
                        <Star className={`h-6 w-6 ${activeFilters.has('rating-4-plus') ? 'text-[var(--primary-theme)] fill-[var(--primary-theme)]' : 'text-gray-400 dark:text-gray-500'}`} />
                        <span className={`text-sm font-medium ${activeFilters.has('rating-4-plus') ? 'text-[var(--primary-theme)]' : 'text-gray-700 dark:text-gray-300'}`}>Rated 4.0+</span>
                      </button>
                      <button
                      ...
                      >
                        <Star className={`h-6 w-6 ${activeFilters.has('rating-45-plus') ? 'text-[var(--primary-theme)] fill-[var(--primary-theme)]' : 'text-gray-400 dark:text-gray-500'}`} />
                        <span className={`text-sm font-medium ${activeFilters.has('rating-45-plus') ? 'text-[var(--primary-theme)]' : 'text-gray-700 dark:text-gray-300'}`}>Rated 4.5+</span>
                      </button>
                    </div>
                  </div>
                )}
                ...
                {activeFilterTab === 'distance' && (
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      >
                        <MapPin className={`h-6 w-6 ${activeFilters.has('distance-under-1km') ? 'text-[var(--primary-theme)]' : 'text-gray-600 dark:text-gray-400'}`} strokeWidth={1.5} />
                        <span className={`text-sm font-medium ${activeFilters.has('distance-under-1km') ? 'text-[var(--primary-theme)]' : 'text-gray-700 dark:text-gray-300'}`}>Under 1 km</span>
                      </button>
                      <button
                      ...
                      >
                        <MapPin className={`h-6 w-6 ${activeFilters.has('distance-under-2km') ? 'text-[var(--primary-theme)]' : 'text-gray-600 dark:text-gray-400'}`} strokeWidth={1.5} />
                        <span className={`text-sm font-medium ${activeFilters.has('distance-under-2km') ? 'text-[var(--primary-theme)]' : 'text-gray-700 dark:text-gray-300'}`}>Under 2 km</span>
                      </button>
                    </div>
                  </div>
                )}
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {['Continental', 'Italian', 'Asian', 'Indian', 'Chinese', 'American', 'Seafood', 'Cafe'].map((cuisine) => (
                        ...
                        >
                          <span className={`text-sm font-medium ${selectedCuisine === cuisine ? 'text-[var(--primary-theme)]' : 'text-gray-700 dark:text-gray-300'}`}>
                            {cuisine}
                          </span>
                        </button>
                      ))}
