            ...
            >
              ...
              <div className="flex items-center justify-between px-4 md:px-6 py-4 md:py-5 border-b dark:border-gray-800">
                ...
                <button
                  ...
                  className="text-[var(--primary-theme)] dark:text-[var(--primary-theme)] font-medium text-sm md:text-base"
                >
                  Clear all
                </button>
              </div>
                  ...
                  {sortOptions.map((option) => (
                    <button
                      ...
                      className={`px-4 md:px-5 lg:px-6 py-3 md:py-4 rounded-xl border text-left transition-colors ${draftSelectedSort === option.id
                        ? 'border-[var(--primary-theme)] bg-red-50 dark:bg-red-900/20'
                        : 'border-gray-200 dark:border-gray-800 hover:border-[var(--primary-theme)]'
                        }`}
                    >
                      <span className={`text-sm md:text-base lg:text-lg font-medium ${draftSelectedSort === option.id ? 'text-[var(--primary-theme)] dark:text-[var(--primary-theme)]' : 'text-gray-700 dark:text-gray-300'}`}>
                        {option.label}
                      </span>
                    </button>
                  ))}
              ...
              <div className="flex items-center gap-4 md:gap-6 px-4 md:px-6 py-4 md:py-5 border-t dark:border-gray-800 bg-white dark:bg-[#1a1a1a]">
                ...
                <button
                  onClick={handleApply}
                  className="flex-1 py-3 md:py-4 font-semibold rounded-xl transition-colors text-sm md:text-base bg-[var(--primary-theme)] text-white hover:bg-[#a81e29]"
                >
                  Apply
                </button>
              </div>
        ...
        {showItemDetail && selectedItem && (
          <>
            ...
            >
              ...
              {/* Bottom Action Bar */}
              <div className="border-t dark:border-gray-800 border-gray-200 px-4 md:px-6 lg:px-8 xl:px-10 pt-3 pb-8 md:pb-5 lg:pb-6 bg-white dark:bg-[#1a1a1a]">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <button
                    ...
                    className="rounded-2xl border border-gray-200 dark:border-gray-700 px-4 py-3 text-sm font-medium text-gray-800 dark:text-gray-200 hover:border-[var(--primary-theme)] hover:text-[var(--primary-theme)] transition-colors"
                  >
                    {option.label}
                  </button>
                ))}
