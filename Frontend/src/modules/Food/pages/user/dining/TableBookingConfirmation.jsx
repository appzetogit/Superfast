  ...
  const goBack = useAppBackNavigation()
    ...
    return (
        <AnimatedPage className="bg-slate-50 min-h-screen pb-24">
            {/* Header */}
            <div className="bg-[var(--primary-theme)] text-white px-4 py-4 sticky top-0 z-50 shadow-md">
                    ...
                    <div className="p-4 space-y-4">
                        <div className="flex items-start gap-3">
                            <div className="bg-red-50 p-2 rounded-xl">
                                <Calendar className="w-5 h-5 text-[var(--primary-theme)]" />
                            </div>
                            <div>
                ...
                <div className="pt-4">
                    ...
                    <div className="space-y-2">
                        <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 flex items-center justify-between">
                            <div className="flex items-start gap-3">
                                <div className="text-[var(--primary-theme)] mt-1">
