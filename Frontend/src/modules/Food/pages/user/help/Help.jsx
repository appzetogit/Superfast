        ...
        <ScrollReveal delay={0.2}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5 lg:gap-6">
              ...
              <CardContent className="p-4 md:p-5 lg:p-6">
                <div className="flex items-center gap-3 md:gap-4">
                  <div className="p-2 md:p-3 bg-red-100 rounded-lg">
                    <User className="h-5 w-5 md:h-6 md:w-6 text-[var(--primary-theme)]" />
                  </div>
                  <div>
            ...
            <CardContent className="p-4 md:p-5 lg:p-6">
              <div className="flex items-center gap-3 md:gap-4">
                <div className="p-2 md:p-3 bg-red-100 rounded-lg">
                  <MessageCircle className="h-5 w-5 md:h-6 md:w-6 text-[var(--primary-theme)]" />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5 lg:gap-6">
                <div className="flex items-start gap-3 p-4 bg-white rounded-lg">
                  <div className="p-2 bg-red-100 rounded-lg">
                    <Phone className="h-5 w-5 text-[var(--primary-theme)]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-3 p-4 bg-white rounded-lg">
                  <div className="p-2 bg-red-100 rounded-lg">
                    <Mail className="h-5 w-5 text-[var(--primary-theme)]" />
                  </div>
                  <div>
                    ...
                    <a
                      href="mailto:support@SUPERFAST.com"
                      className="text-sm text-primary hover:underline font-medium"
                    >
                      support@SUPERFAST.com
                    </a>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-4 bg-white rounded-lg">
                  <div className="p-2 bg-red-100 rounded-lg">
                    <MessageCircle className="h-5 w-5 text-[var(--primary-theme)]" />
                  </div>
                  <div>
