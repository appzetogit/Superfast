    ...
    <div className="min-h-screen bg-gray-50 dark:bg-neutral-900 pb-24">
      ...
      <div className="bg-white dark:bg-neutral-900 p-4 flex items-center sticky top-0 z-20 shadow-sm dark:border-b dark:border-neutral-800">
        ...
        <button
          ...
          className="ml-auto text-sm font-semibold text-[var(--primary-theme)] dark:text-[#ef4444]"
        >
          View History
        </button>
      </div>
      ...
      {/* Order Info */}
      <div className="bg-white dark:bg-neutral-800 mx-4 mt-4 p-4 rounded-xl shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="mx-4 mt-4 space-y-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-3 bg-white dark:bg-neutral-900 border border-gray-300 dark:border-neutral-700 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-[var(--primary-theme)] focus:border-transparent"
            required
          >
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-white dark:bg-neutral-900 border border-gray-300 dark:border-neutral-700 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 rounded-lg focus:ring-2 focus:ring-[var(--primary-theme)] focus:border-transparent"
            required
            maxLength={200}
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={6}
            className="w-full px-4 py-3 bg-white dark:bg-neutral-900 border border-gray-300 dark:border-neutral-700 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 rounded-lg focus:ring-2 focus:ring-[var(--primary-theme)] focus:border-transparent resize-none"
            required
            maxLength={1000}
          />
        ...
        {/* Submit Button */}
        <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-neutral-900 border-t border-gray-200 dark:border-neutral-800 p-4 z-20">
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-[var(--primary-theme)] text-white py-3 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-[#a81e29] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {submitting ? (
              <>
