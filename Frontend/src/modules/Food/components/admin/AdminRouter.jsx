...
const AdminGigsManagement = lazy(() => import("@food/pages/admin/delivery-partners/AdminGigsManagement"));
...
const Support = lazy(() => import("@food/pages/admin/settings/Support"));
      ...
      <Routes>
        ...
        >
          ...
          <Route path="food/*">
            ...
            <Route path="delivery-partners/gigs" element={<AdminGigsManagement />} />
            <Route path="gigs" element={<AdminGigsManagement />} />
            ...
            <Route path="pages-social-media/support" element={<Support />} />
