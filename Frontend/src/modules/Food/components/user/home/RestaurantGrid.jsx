      ...
      <div className="h-full group">
        <Link to={`/user/restaurants/${restaurantSlug}`} className="flex h-full">
          ...
          >
            ...
            <div className="pointer-events-none absolute inset-0 z-0 rounded-md border border-transparent transition-all duration-300 group-hover:border-[var(--primary-theme)]/30 group-hover:shadow-[inset_0_0_0_1px_rgba(204,37,50,0.2)]" />
          </Card>
        </Link>
      </div>
    </div>
