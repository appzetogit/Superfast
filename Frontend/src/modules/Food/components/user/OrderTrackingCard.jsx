...
const CookingAnimation = memo(() => (
  <div className="relative w-12 h-12 flex items-center justify-center rounded-xl bg-red-50 border border-red-100 overflow-visible shadow-[0_4px_15px_rgba(204,37,50,0.15)] shrink-0">
    ...
    <motion.div animate={{ rotate: [-2, 2, -2] }} transition={{ duration: 0.6, repeat: Infinity, ease: "easeInOut" }} className="relative z-10 mt-1">
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[var(--primary-theme)] drop-shadow-sm">
        {/* Cooker Body */}
          ...
          <div className="flex items-center gap-4 relative z-10 w-full">
            ...
            <div className="flex-1 min-w-0 pr-4">
              ...
              <div className="flex items-center gap-1.5 mt-0.5">
                ...
                <ChevronRight className={`w-3.5 h-3.5 ${isQuickOrder ? 'text-blue-500' : 'text-[var(--primary-theme)]'} shrink-0 group-hover:translate-x-1 transition-transform`} />
              </div>
            </div>

            <div className={`bg-gradient-to-br ${isQuickOrder ? 'from-blue-500 to-blue-600 shadow-blue-500/20 border-blue-200' : 'from-[var(--primary-theme)] to-[#a81e29] shadow-red-500/20 border-red-200'} shadow-lg rounded-xl px-4 py-2 shrink-0 flex flex-col items-center justify-center border`}>
