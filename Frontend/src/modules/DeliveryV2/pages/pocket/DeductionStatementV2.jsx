       ...
       <div className="px-4 py-6">
          ...
          {loading ? (
             <div className="flex flex-col items-center justify-center py-12">
                <Loader2 className="w-8 h-8 animate-spin text-[var(--primary-theme)] mb-4" />
             ...
             <div className="flex flex-col items-center justify-center py-12">
                   ...
                   {[...Array(3)].map((_, i) => (
                      <div key={i} className="bg-white rounded-lg p-4 shadow-sm border border-gray-100 w-64 opacity-50">
                         <div className="flex items-start gap-3">
                            <div className={`w-2 h-2 rounded mt-1 ${i === 0 ? 'bg-green-500' : i === 1 ? 'bg-[var(--primary-theme)]' : 'bg-blue-500'}`}></div>
                ...
                <p className="text-gray-400 text-xs font-medium mt-1">No deductions recorded for this week.</p>
             </div>
          ) : (
                      ...
                      <div className="flex items-center justify-between">
                         <div className="flex items-center gap-3">
                            <div className={`w-2 h-2 rounded ${ 
                               ...
                               index % 3 === 1 ? 'bg-[var(--primary-theme)]' : 'bg-blue-500'
                            }`}></div>
                            <div>
