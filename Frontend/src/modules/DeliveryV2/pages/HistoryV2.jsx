                   ...
                   return (
                      ...
                      >
                         <div className="flex justify-between items-start mb-2">
                             ...
                             <span className={`text-sm font-bold ${isCompleted ? 'text-[#10B981]' : isCancelled ? 'text-red-500' : isReassigned ? 'text-[var(--primary-theme)]' : 'text-[var(--primary-theme)]'}`}>
                                {trip.status || 'Status'}
                             </span>
                         </div>
                         
                         <div className="flex gap-2 mb-4 mt-3">
                             <span className={`text-[10px] font-bold px-3 py-1 rounded-full ${isCOD ? 'bg-orange-50 text-[var(--primary-theme)]' : 'bg-green-50 text-[#10B981]'}`}>
                                {isCOD ? 'COD' : 'Online'}
                             </span>
                         </div>
